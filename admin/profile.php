...
<head>
	<title>Profile | LaundryBase</title>
	<meta charset="utf-8">
					...
					<div class="panel panel-profile">
						<div class="clearfix">
								...
								<div class="profile-detail">
									<div class="profile-info">
										...
										<ul class="list-unstyled list-justify">
											...
											<li>Mobile <span><?php echo $pnumber; ?></span></li>
											<li>Email <span><?php echo $email; ?></span></li>
											<li>Website <span><a href="https://www.themeineed.com">www.mike-j.com</a></span></li>
										</ul>
									</div>
									<div class="profile-info">
							...
							<div class="profile-right">
								<h4 class="heading"><?php echo $fname; ?>'s Awards</h4>
								<!-- AWARDS -->
								<div class="awards">
									<div class="row">
