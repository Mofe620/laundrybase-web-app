...
<body style="background-color:#ccccff; 	 background-size: cover;">
	<!-- header -->
	<header>
		<div class="container">
	...
	<div style="text-align:center;">
	  ...
	  <div class="row">
	   <!--1-->
	  <div class="col-sm-6">
		 <div class="item-card card"><br><br>
	  ...
	  <div class="col-sm-6">
		 <div class="item-card card"><br><br>
		    <span class="item" >Trousers</span><br><div><img src="images/c2.jpg" class="" width="50%" height="50%" ></div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="price_pickup.php" method="post" class="p-3" enctype="multipart/form-data" >
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder=" " name="pnumber" id="recipient-name2" required="">
						</div>
					    <div class="form-group">
